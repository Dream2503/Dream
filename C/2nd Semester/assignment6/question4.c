...
Q. Write a program to implement a Input-Restricted Deque(Double-ended queue) by using array. It should have the
...
bool is_full() { return left == 0 && right == n - 1 || left == right + 1; }
