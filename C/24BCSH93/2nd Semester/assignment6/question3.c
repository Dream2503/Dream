...
Q. Write a menu-driven program by using the function defined in Q2 to perform repeated operation on the Queue and
display the status of the Queue after every operation until the user enters his choice to exit
*/
...
bool is_full() { return front == rear; }
