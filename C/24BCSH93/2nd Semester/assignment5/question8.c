...
Q. Write a function to convert postfix expression to infix expression by using stack. Call it in main() to verify whether it is working correctly or not for the following expression.
*/
