...
Q. Write program by using function(intput(), multiply(), display() to input two matrices and do the matrix multiplication after checking suitable condition. Pass necessary parameters in the function.
*/
