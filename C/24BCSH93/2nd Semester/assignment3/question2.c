...
Q. Write program by using function(intput(), transpose(), display() to input a matrix, trnaspose it and display the transposed matrix. Pass necessary parameters in the function.
*/
