...
INSERT INTO movies
VALUES ('Inception', 'Chris Nolan', 'Leo DiCaprio', 'M. Cotillard', 16000000.00, 2010, 9),
...
UPDATE movies m
SET producer = v.producer
FROM (VALUES ('The Dark Knight', 'Emma Thomas'),
             ('Inception', 'Emma Thomas'),
             ('Titanic', 'James Cameron'),
             ('Mad Max Fury', 'Doug Mitchell'),
             ('La La Land', 'Fred Berger'),
             ('EEAAO', 'Jonathan Wang'),
             ('Parasite', 'Kwak Sin-ae'),
             ('Avatar', 'James Cameron'),
             ('Interstellar', 'Emma Thomas'),
             ('The Matrix', 'Joel Silver')) AS v(name, producer)
WHERE m.name = v.name;
